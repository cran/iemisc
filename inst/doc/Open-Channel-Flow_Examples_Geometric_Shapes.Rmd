...
Other examples using the Gauckler-Manning-Strickler equation can be found in [Open Channel Flow Examples using the Gauckler-Manning-Strickler equation](https://www.ecoccs.com/R_Examples/open_channel_flow.html) written by the author.
