...
#'
#'
#' @seealso \code{\link{Manningtrap}} for a triangleal cross-section, \code{\link{Manningrect}} for a
...
#'
#' @export
Manningtri <- function (Q = NULL, n = NULL, m = NULL, Sf = NULL, y = NULL, Temp = NULL, units = c("SI", "Eng")) {
...
# Check
assert_that(!any(qtest(checks, "N+(0,)") == FALSE), msg = "Either Q, n, m, Sf, or y is 0, NA, NaN, Inf, -Inf, empty, or a string. Please try again.")
