...
#' Manningpara(Q = 12.0, B1 = 10, y1 = 2.0, Sf = 0.005, n = 0.05, units = "SI")
#' # Q = 12.0 m^3/s, B1 = 10 m, y1 = 2.0 m, Sf = 0.005, n = 0.05, units = SI units
...
y1use <- uniroot(y1fun, interval = c(1, 100))
...
return(list(y1 = y1, V = V, A = A, P = P, B = B, R = R, Re = Re))
...
B1use <- uniroot(B1fun, interval = c(1, 100))
...
return(list(B1 = B1, V = V, A = A, P = P, B = B, R = R, Re = Re))
...
yuse <- uniroot(yfun, interval = c(1, 100))
